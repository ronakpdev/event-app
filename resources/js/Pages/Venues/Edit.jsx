...
export default function Edit({ venue, accessibilityOptions, layoutOptions }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        tags: venue.tags || [],
        layout: venue.layout || [],
        avg_ratings: venue.avg_ratings || '',
        latitude: venue.latitude || '',
        longitude: venue.longitude || '',
    });

    const [tagsInput, setTagsInput] = useState((venue.tags || []).join(', '));
